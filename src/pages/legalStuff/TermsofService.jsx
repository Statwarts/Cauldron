  ...
  return (
    <>
      ...
      <p>
        ...
        of Cauldron's Website, located at .
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Cauldron if you do not agree to take
      ...
      <p>
        Unless otherwise stated, Cauldron and/or its licensors own the
        intellectual property rights for all material on Cauldron. All
        intellectual property rights are reserved. You may access this from
        Cauldron for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Cauldron</li>
        <li>Sell, rent or sub-license material from Cauldron</li>
        <li>Reproduce, duplicate or copy material from Cauldron</li>
        <li>Redistribute content from Cauldron</li>
      </ul>
      ...
      <p>
        ...
        Cauldron does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Cauldron,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Cauldron shall not be liable
      ...
      <p>
        Cauldron reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Cauldron a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Cauldron; and (d) the link is
      ...
      <p>
        ...
        e-mail to Cauldron. Please include your name, your organization name,
