    ...
    <div className="h-full text-balance bg-gradient-to-t from-[rgb(11,12,15)] to-[#0F1014] p-8 text-[#E5F1FD]">
      ...
      <div className="m-auto flex max-w-5xl flex-col justify-center gap-2 text-pretty text-[#a6a9af]">
        ...
        <p>
          ...
          use of Cauldron's Website, located at{" "}
        ...
        <p className="text-lg font-semibold">You must not:</p>
        ...
        <p>
          ...
          opinions of Cauldron,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Cauldron shall
        ...
        <p>
          ...
          sending an e-mail to Cauldron. Please include your name, your
