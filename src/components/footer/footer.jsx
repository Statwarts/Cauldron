    ...
    return (
        ...
        <div className="bg-[rgb(11,11,14)] text-white">
            <div className="flex flex-wrap-reverse justify-between mb-20">
                <div className="flex-col flex gap-2 m-auto lg:ml-32 lg:justify-normal justify-center md:pt-0 pt-20 pl-2 md:pl-10 lg:pl-0">
                    <img src = {Cauldron} alt = "Cauldron" className="m-auto sm:m-0 w-[70px] lg:w-[85px]" />
                    <div className="text-transparent font-semibold bg-clip-text bg-gradient-to-b from-white to-[rgb(207,231,255)]">
                    <p className=" md:text-6xl text-5xl text-center md:text-balance font-[UncutSans]">Cauldron</p>
                    </div>
                    <p className="text-[rgb(227,231,234,0.7)] md:text-sm mb-10 text-center md:text-balance text-xs">© 2024 Cauldron All rights reserved.</p>
                    <div className="flex gap-5 items-center m-auto md:m-0">
                        <Link to = "">
