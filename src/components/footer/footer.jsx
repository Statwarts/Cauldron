  ...
  return (
    <>
      <div className="relative overflow-hidden bg-[rgb(11,11,14)] pt-10 text-white">
        ...
        <div className="mb-20 max-w-[1400px] mx-auto w-full flex flex-wrap-reverse justify-between">
          <div className="m-auto flex flex-col justify-center gap-2 pl-2 pt-20 md:pt-0 lg:justify-normal">
            <img
              src={Cauldron}
              alt="Cauldron"
